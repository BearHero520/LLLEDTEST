...
-   **美观的菜单式界面**: 14 种核心功能，一键访问所有 LED 控制选项
-   **LED 测试和调试**: 彩虹特效、LED 映射测试、关闭所有 LED
-   **系统配置管理**: 硬盘映射配置、自定义模式、硬盘状态监控
-   **服务管理**: 启动/停止/重启 LED 监控服务，实时状态查看
-   **系统信息**: LED 设备检测、日志查看、完整系统状态
